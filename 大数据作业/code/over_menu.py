class Over_menu():#结束菜单
    def __init__(self, width, height, screen,title_font,sub_font,score):
        self.width = width
        self.height = height
        self.screen = screen
        ...
        color = (255,200,200)
        self.title = title_font.render('Score: %d'%(score),False,color)
        self.option= []
        self.option.append(sub_font.render('Play Again',False,color))
        self.option.append(sub_font.render('Exit',False,color))
        chosen_color = (200,200,255)
        self.chosen_option = []
        self.chosen_option.append(sub_font.render('Play Again',False,chosen_color))
